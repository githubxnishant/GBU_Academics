...
const Ece = () => {
    ...
    useEffect(() => {
        const fetchAllSubjects = async () => {
            try {
                const response = await axios.get("http://localhost:3000/viewsubjects/ece", { timeout: 5000 });
                ...
                <div className='md:w-[70%] flex justify-center mt-6'>
                    <div className='md:w-[95%] w-[90%] h-[92%] overflow-auto'>
                        ...
                        <div className='w-auto h-[4vh] flex justify-between items-center md:my-3 my-2 font-normal md:text-base text-xs'>
                            <h1><span className='text-[#2563eb] underline'>School of Information and Communication Technology </span>&gt;<span className='text-[#2563eb] underline'> ECE</span></h1>
                            <div><SearchBar /></div>
                        </div>
